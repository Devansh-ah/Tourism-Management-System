				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","");
								...
								Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","");
								...
								Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","");
								...
								Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","");
